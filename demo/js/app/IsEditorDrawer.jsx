...
export function IsEditorDrawer({ open, onClose, sourceText, onChange, onApply, onFormat, getTextRef, parseErr, ns = "ISA", apiBase, onApiBaseChange, onConnectApi, onPullConfig, onPushConfig, connectBusy, fixedServer = false }) {
  ...
  return (
    ...
    >
      ...
      <Box className="isa-sw-demo__drawer" role="dialog">
        ...
        <ApiBaseSelect value={apiBase || ""} onChange={onApiBaseChange} onConnect={onConnectApi} busy={connectBusy} ns={ns} disabled={fixedServer} />
